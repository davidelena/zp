				...
				<div class="coCI_content">
					<div class="coCI_jobName">
						...
						<a class="share" href="javascript:;" onclick="shareCompanyInfo()"><img
							src="images_zp/network-share.png" width="16" height="16" alt="分享" />分享公司主页</a>
						<c:if test="${memberInfo.source==2}">
							<a class="share"
								href="recruit/company_info_step1?id=${memberInfo.memberId}"><img
						...
						<c:choose>
							<c:when test="${memberInfo.source==2}">
								...
								<div class="coCI_list">
									<table>
										<tr>
											<td><img src="images_zp/user.png" width="50" height="50"
												alt="1" />${memberInfo.name}</td>
